...
# AUTOGENERATED! DO NOT EDIT! File to edit: ../02_vocabulary.ipynb.

# %% auto 0
__all__ = ['jsonld_merge', 'normalize_wikidata_id']

# %% ../02_vocabulary.ipynb 6
...
# %% ../02_vocabulary.ipynb 7
from .core import *

# %% ../02_vocabulary.ipynb 9
