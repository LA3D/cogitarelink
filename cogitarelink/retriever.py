...
# %% auto 0
__all__ = ['json_parse', 'rdf_to_jsonld', 'URIAnalyzer', 'HTMLAnalyzer', 'LODNavigator']
...
def _determine_access_strategy(self:LODNavigator, uri:str, uri_analysis):
    ...
    if "wikidata" in source:
        ...
        strategy["url"] = f"{uri}.ttl?flavor=simple"
