"""Exposes `reason_over` as a single OpenAI‑style function descriptor."""
...
gm = GraphManager(use_rdflib=True)   # shared, memory‑safe

# %% ../../70_tool_reason.ipynb 4
FUNCTION_SPEC:Dict = {
  "name":"reason_over",
  "description":"Run SHACL rules or SPARQL CONSTRUCT on JSON‑LD and update memory",
  "parameters":{
    "type":"object",
    "properties":{
